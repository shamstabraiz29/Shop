...
<main class="min-h-screen bg-white">
  ...
  <section class="bg-linear-to-r from-primary to-primary/80 py-16 lg:py-24">
    <div class="mx-auto max-w-[92%] lg:max-w-[75%]">
      ...
      <p class="text-lg text-white/90 text-center mt-4 max-w-2xl mx-auto">
        Kurtas, casual shirts & formal wear — refined Pakistani styles for every
        occasion
      </p>
    </div>
  </section>
  ...
  <CtaSection
    ...
    description="Explore all Pakistani menswear or reach out for size and styling guidance."
    primaryButton={{
      label: 'Shop Menswear',
      href: '/shop',
      variant: 'primary',
